                                                ...
                                                <div className="flex items-start justify-between gap-4">
                                                    ...
                                                    <div className="flex flex-col items-center justify-center px-4 pt-1 w-24">
                                                        ...
                                                        <div className="w-full h-[2px] bg-gray-200 dark:bg-slate-600 relative">
                                                            <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-2 h-2 rounded-full border-2 border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-900" />
                                                            <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-gray-300 dark:bg-slate-500" />
                                                            <Plane className="w-4 h-4 text-brand-primary absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90 bg-gray-50 dark:bg-slate-800" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex-1 text-right">
                                                        ...
                                                        <div className="text-xs text-gray-500 dark:text-slate-400 leading-snug">{leg.arrivalAirport.name}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
