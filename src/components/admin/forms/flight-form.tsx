    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
                <h3 className="text-sm font-extrabold text-brand-dark uppercase tracking-wider">Flight Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <select className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-brand-primary/30 focus:border-brand-primary/40 transition-colors">
            ...
            <div className="pt-4 border-t border-gray-100 flex justify-end gap-3">
                ...
                <Button type="submit" className="bg-brand-primary hover:bg-brand-secondary text-white">Create Flight</Button>
            </div>
        </form>
    );
};
