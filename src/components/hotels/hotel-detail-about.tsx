        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                {highlights.map((item, idx) => (
                    <div key={idx} className="flex flex-col items-center justify-center p-4 border border-border rounded-xl text-center gap-2 hover:bg-muted/50 dark:hover:bg-slate-800/50 hover:border-brand-primary/20 hover:shadow-sm transition-all duration-300">
            ...
            <div className="space-y-4">
                <h3 className="text-lg font-bold text-foreground pt-1">About this property</h3>
                {hotel?.description ? (
                    ...
                    <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
                        <p>
                            Enjoy a comfortable stay at <span className="font-bold text-foreground">{hotel.name}</span> in {hotel.location}. Popular amenities include Free WiFi, Parking, and Family rooms.
                        </p>
                        <p>
            ...
            <div className="pt-6 border-t border-border">
                <h3 className="text-base font-bold text-foreground mb-6">Property facilities</h3>
